...
@RestController public class HealthController{@GetMapping("/api/health") public Map<String,Object> health(){return Map.of("service","intelix-backend","status","UP","intelligence","READY");}}
